...
import com.example.newsapptask.auth_feature.presentation.viewmodels.RegisterViewModel
...
fun RegisterScreen(navController: NavController, viewModel: RegisterViewModel = hiltViewModel()) {
    ...
    LaunchedEffect(Unit) {
        viewModel.registrationState.collectLatest { resource ->
            when (resource) {
                is Resource.Loading -> {
    ...
    Column(
        ...
        Row(
            ...
            Text(text = "Already have an account?", style = TextStyle(fontSize = 17.sp))
